...
def process_dump(input_file, template_file, out_file, file_size, file_compress,
    ...
    if input_file == '-':
        ...
        input = fileinput.FileInput(input_file, openhook=fileinput.hook_compressed_encoded("utf-8"))
...
def main():
    ...
    if args.article:
        ...
        file = fileinput.FileInput(input_file, openhook=fileinput.hook_compressed_encoded("utf-8"))
